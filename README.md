...
Generated-problem eval fixtures live in `backend/src/test/resources/generated-problems/`. Add valid and invalid fixtures there when changing prompt versions, mapping, or validation rules so the backend test suite captures generation quality regressions.
